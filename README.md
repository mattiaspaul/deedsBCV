...
| Registration Method  | ANTS-Quick MI | IRTK | NiftyReg | deeds | deeds+JLF |
| ------------- | --------- | --------- | --------- |  --------- |  --------- | 
...
The code requires a g++ compiler. Optional but recommend are OpenMP support and SSE4.2 and AVX2 flags.
...
There are two more parameters, which specify the discrete search namely the radius (of steps):
 ...
 and the quantisation of the search steps
...
In case you do not want to creat a synapse.org account please see below.
